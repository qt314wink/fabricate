...
/**
 * Minimal GRBL-flavored 3-axis post for the plate contour + hole cycles.
 * Units: mm. Plane XY. Absolute.
 * This is a teaching / preview post — not a machine warranty.
 */
...
export function postBracketGcode(params: BracketParams, opt: GcodeOptions = {}): string {
  ...
  const lines: string[] = [
    ...
    "; GRBL-ish / G21 mm / G90 abs / G17 XY",
    "G21 G90 G17",
    "G0 Z" + fmt(safeZ),
...
/** Linearize G0/G1 with modal X Y Z. Ignores other words. */
