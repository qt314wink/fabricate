...
//#region node_modules/.nitro/vite/services/ssr/assets/router-zcRrusp0.js
...
var styles_default = "/assets/styles-YRQmwEC7.css";
var APP_NAME = "Fabricate";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Motion for parametric objects that must not pop. One clock, three cells."
			},
			{
				name: "theme-color",
				content: "#0a0b0d"
...
var $$splitComponentImporter = () => import("./routes-C6PQFUVp.mjs");
